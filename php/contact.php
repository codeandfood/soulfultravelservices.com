...
$to    = "soulfultravelservices@gmail.com"; // <--- Your email ID here

$server_email = 'soulfultravelservices@gmail.com';  // Your server email to authenticate outgoing emails. eg: name@yourdomain.com
